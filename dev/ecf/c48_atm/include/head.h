...
# C96 dev override: NCO's prod_envir loader silently re-assigns ECF_HOST and
# ECF_PORT to the operational ecflow servers via /lfs/h1/ops/prod/config/dhostfile.
# Re-pin them to our dev server before the --init call (the suite-level vars
